...
def onEvent(evt):
    ...
    if photon_count:
        ...
        if (nrPhotons_acc['train_count']%train_interval == 0):
            ...
            print(f'nrPhotons averaged over {time_elapse} s')
            nrPhotons_avg = add_record(evt['analysis'], 'analysis', 'mean nrPhotons', nrPhotons_acc['photons']/time_elapse)
